...
//        add_filter('fluentform_notifying_async_amocrm', '__return_false');

        $this->logo = $this->app->url('public/img/integrations/amocrm.png');
        ...
        add_filter(
            'fluentform_get_integration_values_amocrm',
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (!is_wp_error($response)) {
            do_action('ff_integration_action_result', $feed, 'success', 'Amocrm feed has been successfully initiated and pushed data');
        } else {
