...
class Bootstrap extends IntegrationManager
{
    ...
    public function getGlobalFields($fields)
    {
        return [
            ...
            'menu_description' => __('Hubspot is a CRM software. Use Fluent Forms to collect customer information and automatically add it as Hubspot subscriber list.', 'fluentformpro'),
