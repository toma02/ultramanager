...
class Bootstrap extends IntegrationManager
{
    public function __construct(Application $app)
    {
        ...
        $this->logo = $this->app->url('public/img/integrations/onepagecrm.png');

        $this->description = "Complete your actions with the combination of Fluent Forms and OnePageCRM to collect leads and more.";

        $this->registerAdminHooks();

//        add_filter('fluentform_notifying_async_onepagecrm', '__return_false');
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (!is_wp_error($response)) {
            do_action('ff_integration_action_result', $feed, 'success', 'OnePageCRM feed has been successfully initiated and pushed data');
        } else {
