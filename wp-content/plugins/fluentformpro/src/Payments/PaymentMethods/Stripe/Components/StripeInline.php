...
namespace FluentFormPro\Payments\PaymentMethods\Stripe\Components;
...
class StripeInline extends BaseFieldManager
{
    ...
    public function __construct()
    {
        ...
        add_filter('fluentform_payment_method_contents_stripe', array($this, 'maybePushPaymentInputs'), 10, 4);
    }
    ...
    public function maybePushPaymentInputs($inlineContents, $method, $data, $form)
    {
        ...
        add_filter('fluentform_form_class', function ($classes, $targetForm) use ($form) {
