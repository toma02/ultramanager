...
class Plan
{
    ...
    public static function getGeneratedSubscriptionId($subscription, $currency = 'USD')
    {
        ...
        return apply_filters('fluentform_stripe_plan_name_generated', $subscriptionId, $subscription, $currency);
    }
    ...
    public static function getSubscriptionPlanBySubscription($subscription, $currency)
    {
        ...
        $planName = apply_filters('fluentform_stripe_plan_name', implode('_', $planNameArgs), $subscription);
    ...
    public static function maybeSetCancelAt($subscription, $stripeSub)
    {
        ...
        $secretKey = apply_filters('fluentform-payment_stripe_secret_key', StripeSettings::getSecretKey($subscription->form_id), $subscription->form_id);
