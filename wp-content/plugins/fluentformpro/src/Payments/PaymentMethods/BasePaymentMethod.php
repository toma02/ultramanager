...
abstract class BasePaymentMethod
{
    ...
    public function __construct($key)
    {
        ...
        add_filter('fluentformpro_payment_methods_global_settings', function ($methods) {
        ...
        add_filter('fluentform_payment_settings_'.$this->key, array($this, 'getGlobalSettings'));
    }
