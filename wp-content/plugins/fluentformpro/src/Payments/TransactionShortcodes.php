...
class TransactionShortcodes
{
    public function init()
    {
        ...
        add_action('fluent_payment_view_payment', array($this, 'renderPaymentReceiptPage'));
    }
    ...
    private function getViewConfig()
    {
        ...
        return apply_filters('fluentform_payment_view_config', [
            'new_tab'                    => false,
    ...
    private function canCancelSubscription($subscription)
    {
        ...
        return $method == 'stripe' || apply_filters('fluentform_pay_method_has_sub_cancel_' . $method, false);
    }
